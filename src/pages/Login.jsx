        ...
        <div className="max-w-[450px] h-[650px] mx-auto">
          <div className="max-w-[320px] mx-auto py-16">
            <form className="w-full mt-[30%] flex flex-col py-4">
              <h2 className='text-white font-bold text-center text-2xl'>ACESSAR</h2>
              <input
              ...
              <button className="my-6 rounded-full py-2 bg-orange-400 hover:bg-orange-600 text-white text-xl">
                <Link to='/spells'>ENTRAR</Link>
              </button>
              <div>
                <p className='text-white text-center'>Não possui acesso? <span className='font-bold hover:text-orange-600'><Link to='/signup'>CADASTRE-SE</Link></span></p>
              </div>
            </form>
          </div>
        </div>
